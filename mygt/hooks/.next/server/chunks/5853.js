...
const tslib_1 = __webpack_require__(10394);
const events_1 = __webpack_require__(82361);
const cross_fetch_1 = tslib_1.__importDefault(__webpack_require__(94691));
...
class HttpConnection {
    constructor(url, disableProviderPing = false) {
        ...
        if (!(0, jsonrpc_utils_1.isHttpUrl)(url)) {
    ...
    send(payload, context) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            try {
                const body = (0, safe_json_1.safeJsonStringify)(payload);
        ...
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            try {
                if (!this.disableProviderPing) {
                    const body = (0, safe_json_1.safeJsonStringify)({ id: 1, jsonrpc: "2.0", method: "test", params: [] });
    ...
    parseError(e, url = this.url) {
        return (0, jsonrpc_utils_1.parseConnectionError)(e, url, "HTTP");
    }
    resetMaxListeners() {
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
const tslib_1 = __webpack_require__(10394);
const http_1 = tslib_1.__importDefault(__webpack_require__(38905));
tslib_1.__exportStar(__webpack_require__(38905), exports);
...
let convert;
try {
	convert = (__webpack_require__(92609).convert);
} catch (e) {}
...
const utils = __webpack_require__(79916);
